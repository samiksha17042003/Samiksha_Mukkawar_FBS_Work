...
class DeviceInheritance{
	 public static void main(String[] args) {
		 Mobile m=new Mobile("Samsunga","Galaxy A26 5G",24999,5000,2,50,128,"Yes");
		 m.display();
		 System.out.println();
		 Laptop l=new Laptop("Asus","11 Gen",60000,1000,128,"IntelCoreI5","Linux");
		 l.display();
		 System.out.println();
		 SmartWatch b=new SmartWatch("Samsunga","Galaxy Watch7",32999,5000,1000,10000);
		 b.display();
