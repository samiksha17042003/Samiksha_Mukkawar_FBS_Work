...
Product arr[]=new Product[4];//array of reference
arr[0]=new Product();
arr[1]=new Product(1213,"Mobile",500000,4);
arr[2]=new Product(1342,"Bluetooth",450000,6);
arr[3]=new Product(6756,"Charger",3000,8);
